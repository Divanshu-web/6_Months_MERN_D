...
import { ADD_REQUEST, ADMIN_BASE_URL, ALL_REQUEST, LEARNER_BOOKINGS, BASE_URL, DELETE_REQUEST, SINGLE_REQUEST, UPDATE_REQUEST } from "../endPoints";
...
export function getLearnerBookings(data) {
   return axios.post(ADMIN_BASE_URL + LEARNER_BOOKINGS, data, getToken())
}
