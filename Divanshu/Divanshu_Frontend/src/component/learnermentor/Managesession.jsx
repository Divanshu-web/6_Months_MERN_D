...
function SessionCard({ session, index, viewMode, onDelete, onRequest, currentUserId }) {
    ...
    const payNow = async () => {
        try {
            const orderRes = await axios.post("http://localhost:3000/api/create-order", { amount })
            ...
            let options = {
                ...
                handler: function (response) {
                    ...
                    console.log("Rax=zor response: ", response)
                },
                theme: '#000',
            }
