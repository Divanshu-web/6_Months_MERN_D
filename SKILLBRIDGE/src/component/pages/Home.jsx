        ...
        <div className="container py-5">
          <div className="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <h1 className="display-3 mb-4">
              Learn Real-World Skills from Experts</h1>
            <p className="mb-0">
              SkillBridge is a platform designed to help students and learners gain practical skills for real-world success. We connect passionate learners with experienced mentors who teach valuable skills like web development, programming, design, communication, and more. Our goal is to bridge the gap between knowledge and practical ability by providing easy access to skill-based learning and guidance.

              Through SkillBridge, learners can explore different skills, practice through projects, and build confidence for their future careers.
            </p>
          </div>
          <div className="row g-4 justify-content-center">
              ...
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    <h5 className="mb-4">Cooking</h5>
                    <p className="mb-4">
                      Cooking classes teach essential culinary skills, ingredient selection, and techniques, helping learners prepare healthy, delicious meals with confidence and creativity. 🍳👨‍🍳
                    </p>
                    <a
                      href="#"
            ...
            >
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    <h5 className="mb-4">Animation</h5>
                    <p className="mb-4">
                      Animation classes teach students to create moving visuals using drawing, design, and digital tools, building creativity and storytelling skills. 🎨🎬
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
            ...
            >
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    <h5 className="mb-4">Beauty &amp; Makeup</h5>
                    <p className="mb-4">
                     Beauty and makeup classes teach skincare, makeup techniques, product knowledge, and professional styling skills to enhance appearance, confidence, and creativity. 💄✨
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
            ...
            >
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    <h5 className="mb-4">Fashion Designing</h5>
                    <p className="mb-4">
                     Fashion designing classes teach clothing design, fabric selection, sketching, and sewing skills to create stylish outfits and develop creativity in fashion. 👗✨
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
              ...
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    ...
                    <p className="mb-4">
                     Digital marketing classes teach online promotion using social media, SEO, content, and ads to grow brands, reach audiences, and increase sales. 📱💻📈
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
              ...
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    ...
                    <p className="mb-4">
                     Video editing classes teach cutting clips, adding effects, transitions, sound, and color correction to create engaging, professional-quality videos. 🎬💻✨
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
            ...
            >
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    <h5 className="mb-4">Interior Designing</h5>
                    <p className="mb-4">
                      Interior designing classes teach space planning, color selection, furniture arrangement, and décor techniques to create functional, stylish, and comfortable indoor spaces. 🏠🎨✨
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
            ...
            >
              <div className="service-item rounded">
                ...
                <div className="service-content rounded-bottom bg-light p-4">
                  <div className="service-content-inner">
                    <h5 className="mb-4">Fitness Training</h5>
                    <p className="mb-4">
                     Fitness training classes teach exercise techniques, strength building, flexibility, and healthy habits to improve physical fitness, endurance, and overall well-being. 💪🏃‍♂️✨
                    </p>
                    <a
                      href="#"
                      className="btn btn-primary rounded-pill text-white py-2 px-4 mb-2"
          ...
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
              <div className="section-title text-start mb-5">
                ...
                <h1 className="display-3 mb-4">
                  We are Ready to Help Improve Your Skills.
                </h1>
                <p className="mb-4">
                  SkillBridge is an online learning platform created to help students and learners develop practical skills that are important in today’s world. Our mission is to bridge the gap between theoretical knowledge and real-world skills by providing easy access to skill-based learning.

                  At SkillBridge, we believe that everyone should have the opportunity to learn new skills and grow. Our platform allows learners to explore different skill areas such as programming, web development, design, communication, and many more. Experienced mentors and experts guide learners so they can improve their abilities and gain confidence.
                </p>
                <div className="mb-4">
                  <p className="text-secondary">
                    <i className="fa fa-check text-primary me-2" /> We focus on practical learning, hands-on practice, and continuous improvement so that learners can apply their knowledge in real-life situations.
                  </p>
                  <p className="text-secondary">
                    <i className="fa fa-check text-primary me-2" /> Our goal is to empower individuals with the right skills, helping them build better careers and achieve their personal and professional goals.
                  </p>
                  <p className="text-secondary">
      ...
      <div className="container-fluid feature py-5">
        <div className="container py-5">
          <div className="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="display-3 mb-4">
            Empowering learners with practical skills, expert guidance, and opportunities for real-world career growth
            </h1>
            <p className="mb-0">
              SkillBridge helps learners develop practical skills through expert guidance and easy access to learning resources. It offers opportunities to explore different skill areas, gain real-world knowledge, and improve career readiness in a simple, supportive, and interactive learning environment
            </p>
          </div>
          <div className="row g-4 justify-content-center">
            <div
      ...
      <div className="container-fluid team py-5">
        <div className="container py-5">
          <div className="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="display-3 mb-4">
              Skill Services from Professional Teacher
            </h1>
            <p className="mb-0">
              Our team consists of passionate mentors and professionals dedicated to helping learners grow. With expertise in various skill areas, they guide students through practical learning, provide support, and create a positive environment that encourages knowledge sharing, creativity, and continuous skill development
            </p>
          </div>
          <div className="row g-4 justify-content-center">
            <div
      ...
      >
        <div className="container py-5">
          <div className="section-title mb-5">
            ...
            <h1 className="display-3 mb-4">What trainees are Say</h1>
          </div>
      ...
      <div className="container-fluid blog py-5">
        <div className="container py-5">
          <div className="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="display-3 mb-4">
              Excellent Facility and High Quality Skills
            </h1>
            <p className="mb-0">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat
              deleniti amet at atque sequi quibusdam cumque itaque repudiandae
